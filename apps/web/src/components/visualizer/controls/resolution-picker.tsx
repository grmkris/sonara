...
import { RENDER_RESOLUTIONS } from "@sonara/shared";
...
// A/B switcher for the live-session render resolution (?lab=1 only). Picks
// are client-authoritative — stored locally and re-sent to the server on
// (re)connect (see use-ws-session).
export const ResolutionPicker = ({ send }: ResolutionPickerProps) => {
