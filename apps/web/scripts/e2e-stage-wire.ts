/* oxlint-disable no-promise-executor-return, avoid-new, param-names, no-explicit-any, no-array-sort, prefer-add-event-listener -- throwaway uncommitted E2E harness, not part of the app */
// E2E verification of the Monad stage wire on a deployed environment.
// Run manually (not part of any CI gate):
